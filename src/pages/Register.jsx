...
import { UserPlus, Mail, Lock, User, AlertCircle, Newspaper, KeyRound, RefreshCw, CheckCircle, Shield } from 'lucide-react';
...
const Register = () => {
  ...
  useEffect(() => {
    ...
    setPasswordStrength({ score: Math.min(score, 6), text, color });
  }, [password]);
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-charcoal-500 mt-2">
            {step === 1 ? 'Join our community of readers' : 'Enter the OTP sent to your email'}
          </p>
        </div>
              ...
              <>
                        ...
                        {[...Array(6)].map((_, i) => (
                          <div
                            ...
                            className={`h-1 flex-1 rounded ${
                              i < passwordStrength.score ? passwordStrength.color : 'bg-charcoal-200'
                            }`}
                          />
                        ))}
                      </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-xs text-charcoal-600">
                    Your email will be verified via OTP before registration is complete.
                  </p>
                </div>
              </>
            )}
